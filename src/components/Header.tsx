...
import { Settings, Bell, BellOff, Info, BarChart3 } from 'lucide-react'
        ...
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className={`flex items-center gap-1 p-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${notificationStatus.color}`}
                title="通知状態を確認"
              >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label={isSettingsView ? 'ダッシュボードに戻る' : '設定を開く'}
